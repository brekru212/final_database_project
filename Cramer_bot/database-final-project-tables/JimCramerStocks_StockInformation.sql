...
CREATE TABLE `StockInformation` (
  ...
  `priceDaily` decimal(7,2) DEFAULT NULL,
  `timesMentioned` int(11) NOT NULL,
  PRIMARY KEY (`ticker`),
  UNIQUE KEY `ticker` (`ticker`),
  CONSTRAINT `StockInformation_ticker_fk` FOREIGN KEY (`ticker`) REFERENCES `CramerEntries` (`ticker`) ON DELETE CASCADE ON UPDATE NO ACTION
